...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
	...
	<link rel="stylesheet" href="css/ingresarC.css">
</head>
<body>
<div class="contenedor">
	<span class="icon"><figure class=""><img src="../../home/img/favicon.png" alt="Logo SMIEP" width="170px" href="../../sesiones/menu.php"></figure></span>
        
<header class="header">
Ingresa los datos de categoria
</header>
<div class="tabla">
<form  action='../controlador/administrar_Categoria.php' id="formulario" name="formulario" method='post'>
	<table class="tabla">
		<tr>
