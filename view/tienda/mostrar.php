	...
	<div id="main-container">
		...
		<tr class="tienda">
			...
			<td><a class="editar" id="btnActualizar" name="btnActualizar"
					href="actualizar.php?id_ti=<?php echo $Tienda->getId_ti()?>&accion=a"><button type="button"><i
							class="fa-solid fa-pencil"></i></button></a></td>
			<td><a type="submit" class="eliminar" id="btnEliminar" name="btnEliminar"
					href="../../controller/tiendaCtrl.php?id_ti=<?php echo $Tienda->getId_ti()?>&accion=e"><button
