					...
					<fieldset class="anuncio movAds">
						...
						<div>
							<article>
								...
								<p><strong>Documento de Identidad:</strong> El Documento del Proveedor no puede ser modificado.</p>
								</br>
								<p><strong>Nombres y Apellidos:</strong> En estos cuatro campos se pueden actualizar los nombres y apellidos.</p>
								</br>
								<p><strong>Información Empresa</strong> En estos campos se podra Actualizar el Nombre de la Empresa, Imagen de la Empresa, Dirección, Telefono y Correo.
							</p>
							</article>
						</div>
					</fieldset>
