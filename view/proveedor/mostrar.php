...
<div id="main-container">
	<thead>
		<tr>
			<th>Listado de Proveedores
			<th>
			<th colspan="7" class="bot1"><a href='ingresar.php'><button type="button" id="agregar"><i
	...
	<tr class="proveedor">
		...
		<td><a class="editar" id="btnActualizar" name="btnActualizar"
				href="actualizar.php?id_DocProv=<?php echo $Proveedor->getId_DocProv()?>&accion=a"><button
					type="button"><i class="fa-solid fa-pencil"></i></button></a></td>
		<td><a type="submit" class="eliminar" id="btnEliminar" name="btnEliminar"
				href="../../controller/proveedorCtrl.php?id_DocProv=<?php echo $Proveedor->getId_DocProv()?>&accion=e"><button
