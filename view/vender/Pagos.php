...
{ // include database configuration file    
    ...
    include 'La-carta.php';    $cart = new Cart;
    ...
    $_SESSION['sessCustomerID'] = 1234;
    // get customer details by session customer ID    
    $query = $db->query("SELECT * FROM cliente WHERE id_cliDoc = " . $_SESSION['sessCustomerID']);    $custRow = $query->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="es">
...
?>
    ...
    { ?>
                ...
                <div class="shipAddr">
                    ...
                    <p>
                        <?php echo $custRow['nombreCli1']; ?>
                    </p>
                    <p>
                        <?php echo $custRow['emailCli']; ?>
                    </p>
                    <p>
                        <?php echo $custRow['telCli']; ?>
                    </p>
                    <p>
                        <?php echo $custRow['direccionCli']; ?>
                    </p>
                </div>
                <div class="footBtn">
