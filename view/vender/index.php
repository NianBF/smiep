                    ...
                    <div class="item col-lg-4">
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <figure><img src="<?php echo $row[" imgProd"]; ?>" alt="
                                    <?php echo $row["nombreProd"]; ?>" width="20%">
                                </figure>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="lead">
                                            <?php echo '$' . $row["precio"] . ' COP'; ?>
                                        </p>
                                    </div>
                                    <div class="col-md-6">
                                        <a class="btn btn-success"
                                            href="AccionCarta.php?action=addToCart&id_prod=<?php echo $row[" id_prod"];
?>">Agregar a la Carta</a>
                                    </div>
                                </div>
                            </div>
                        </div>
