...
?>
                        <tr>
                            ...
                            <td>
                                <a href="AccionCarta.php?action=removeCartItem&id_prod=<?php echo $item[" rowid"]; ?>"
                                    class="btn btn-danger" onclick="return confirm('¿Seguro que quiere eliminar?')"><i
