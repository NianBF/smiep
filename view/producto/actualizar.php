				...
				<fieldset class="contact-form">
					...
					<section class="formularios">
						...
						<div class="page formPage">
							...
							<div class="userBox">
								<input type='number' id="cantDisp" name='cantDisp' placeholder=" "
						...
						<div class="page infTi">
							...
							<div class="userBox">
								<input type='number' id="id_docUsu" name='id_docUsu' placeholder=" "
									value="<?php echo $_SESSION['docUsu']; ?>" required>
