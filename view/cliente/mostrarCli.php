    ...
    <div id="main-container">
        <thead>
            <tr>
                ...
                <th colspan="5" class="bot1"><a href='ingresar.php'><button type="button" id="agregar"><i
        ...
        <tr class="cliente">
            ...
            <td><a class="editar" id="btnActualizar" name="btnActualizar"
                    href="actualizar.php?id_cliDoc=<?php echo $Cliente->getId_cliDoc();?>&accion=a"><button
                        type="button"><i class="fa-solid fa-pencil"></i></button></a></td>
            <td><a type="submit" class="eliminar" id="btnEliminar" name="btnEliminar"
                    href="../../controller/clienteCtrl.php?id_cliDoc=<?php echo $Cliente->getId_CliDoc()?>&accion=e"><button
