...
<div id="main-container">
	<thead>
		<tr>
			<th>Listado de Usuario</th>
			<th colspan="6" class="bot1"><a href='ingresar.php'><button type="button" id="agregar"><i
	...
	<tr class="usuario">
		...
		<td><a class="btn btn-outline-light editar" id="btnActualizar" name="btnActualizar"
				href="actualizar.php?id_doc=<?php echo $Usuario->getId_doc()?>&accion=a"><button type="button"><i
		...
		<td><a type="submit" class="btn btn-outline-light eliminar" id="btnEliminar" name="btnEliminar"
				href="../../controller/usuarioCtrl.php?id_doc=<?php echo $Usuario->getId_doc()?>&accion=e"><button
