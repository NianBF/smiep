        ...
        <div class="loseUser">
            <form action="../../../controller/recoveryPassCtrl.php" method="post">
                <fieldset class="anuncio">
                    ...
                    <div>
                        <article>
                            <p>Este proceso solo puede ser realizado para usuarios con permisos especiales. <strong>S.M.I.E.P</strong> no se hace responsable de la filtración, fuga o perdida de datos que pueda provocar usted al hacer uso de este apartado.</p></br>
