...
<head>
    ...
    <title>SMIEP</title>
    <link rel="stylesheet" type="tect/css" href="https://smiep.herokuapp.com/css/login.css">
</head>

<body>
    <div class="headerSmiep">
        <header>
            <figure class="icon"><img src="../../img/favicon.png" alt="Logo SMIEP" width="200rem"></figure>
            <section>
