      ...
      B = function (a, o, n, r) {
        ...
        if (e.showOnlyTheLastOne && 0 < A)
          for (
            ...
            (R = M[B]), null !== R.parentNode && R.parentNode.removeChild(R);
        e = y(!0, e, c);
      },
        ...
        if (e)
          for (var z = 0; z < N; z++) {
            ...
            if (1 > A.length) {
              ...
              (E.id = f.ID + "-" + j),
                (E.className =
                  h + "-wrap" + (n.cssAnimation ? " with-animation" : "")),
                ...
                n.rtl &&
                  (E.setAttribute("dir", "rtl"), E.classList.add("rtl-on")),
                (E.innerHTML = B + F);
              var D = t.getComputedStyle(M).getPropertyValue("position"),
                T =
                  "string" == typeof D ? D.toLocaleLowerCase("en") : "relative",
              ...
              var G = "",
                U =
                  -1 >= ["absolute", "relative", "fixed", "sticky"].indexOf(T);
              if (U || 0 < Q.length) {
                if (!g("head")) return !1;
